...
cons_lm2 <- dynlm(Yt ~ Xt + L(Xt, 1) + L(Xt, 2) + L(Xt, 3) + L(Xt, 4) +
                        L(Xt, 5) + L(Xt, 6) + L(Xt, 7) + L(Xt, 8) + L(Xt, 9) + L(Yt), data = train.ts)

#sama dengan ardl p=9 q=13
cons_lm3 <- dynlm(Yt ~ Xt + L(Xt, 1) + L(Xt, 2) + L(Xt, 3) + L(Xt, 4) + 
                        L(Xt, 5) + L(Xt, 6) + L(Xt, 7) + L(Xt, 8) + L(Xt, 9) + L(Yt)+ L(Yt, 1) + L(Yt, 2) + L(Yt, 3) + L(Yt, 4) +
                        L(Yt, 5) + L(Yt, 6) + L(Yt, 7) + L(Yt, 8) + L(Yt, 9) + 
                        L(Yt, 10) + L(Yt, 11) + L(Yt, 12) + L(Yt, 13), data = train.ts)

#sama dengan dlm p=10
cons_lm4 <- dynlm(Yt ~ Xt + L(Xt, 1) + L(Xt, 2) + L(Xt, 3) + L(Xt, 4) +
                        L(Xt, 5) + L(Xt, 6) + L(Xt, 7) + L(Xt, 8) + L(Xt, 9) + L (Xt, 10), data=train.ts)
```
